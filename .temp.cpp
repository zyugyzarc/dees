...
int main(){
	/*;
var fizzbuzz = var(0);
fizzbuzz.__exec__ = (std::function<var(var)>)[=, &fizzbuzz](var __args){var n = __args.__getitem__(var(0));
;
;
for(var i=var(1); i<(n+var(1)); i=i+var(1)){
;
;
if(i%var(3)==var(0)&&i%var(5)==var(0)){;
print(var({i,var((std::string)"fizzbuzz")}));
}else if(i%var(3)==var(0)){;
print(var({i,var((std::string)"fizz")}));
}else if(i%var(5)==var(0)){;
print(var({i,var((std::string)"buzz")}));
}else{;
print(var({i}));
};
...
;return var(0,0);};
;
fizzbuzz.__exec__(var({var(100)}));
*/;
;
var(10)=var(10);
print(var({var((std::string)"Hello World")}));
;
